                            ...
                            <InboxNotification 
                                ...
                                kinds={{
                                    ...
                                    $documentAccess: (props) => (
                                        <InboxNotification.Custom {...props} title={props.inboxNotification.activities[0].data.title} aside={<InboxNotification.Icon><Image src={props.inboxNotification.activities[0].data.avatar as string || ''} alt="Avatar" width={36} height={36} className="rounded-full"/></InboxNotification.Icon>}>
                                            {props.children}
